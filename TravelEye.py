...
class TravelEye(QMainWindow):
    ...
    def set_button_style(self, button):
        # Button styles with a solid green background when pressed
    ...
    def go_to_menu(self):
        # Here you might want to pass the last scanned frequency details to `multipleChoiceMenu`
    ...
    def update_recursive_scan(self):
        ...
        # Perform scan on the current frequency
